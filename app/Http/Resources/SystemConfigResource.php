...
class SystemConfigResource extends JsonResource
{
  ...
  public function toArray($request)
  {
    ...
    return [
      ...
      "smart_form_id_for_registration" => $request->is('api/vendor/*') ? $this->smart_form_id_for_vendor_additional_info : $this->smart_form_id_for_customer_registration_form,

      "show_terms_and_conditions_on_registration" => $request->is('api/vendor/*') ? (bool) $this->show_vendor_terms_and_conditions : (bool) $this->show_customer_terms_and_conditions,
      ...
      'smart_form_id_for_contact_us_page' => $request->is('api/vendor/*') ? $this->smart_form_id_for_selling_page : $this->smart_form_id_for_contact_us_page,
