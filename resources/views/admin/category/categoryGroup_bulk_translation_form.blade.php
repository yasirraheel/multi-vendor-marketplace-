<div class="modal-dialog modal-md">
  <div class="modal-content">
    {!! Form::open(['route' => 'admin.catalog.categoryGroup.translate.bulk.upload', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
    ...
    <div class="modal-body">
      <ul>
        ...
        <li>{!! trans('help.download_template', ['url' => route('admin.catalog.categoryGroup.translate.download.template')]) !!}</li>
        <li>{!! trans('help.first_row_as_header') !!}</li>
        <li>{!! trans('help.required_fields_csv', ['fields' => 'slug, lang, name, description']) !!}</li>
      ...
      <div class="row">
        ...
        <div class="col-md-3 nopadding-left">
          <div class="fileUpload btn btn-primary btn-block btn-flat">
            ...
            <input type="file" name="categoryGroupTranslations" id="uploadBtn" class="upload" />
          </div>
        </div>
      </div>
    </div>
