...
@section('content')
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">
        {{ trans('app.model_translations_bulk_upload', ['model' => trans('app.model.category_sub_group')]) }} {{ trans('app.preview') }} <small>({{ trans('app.total_number_of_rows', ['value' => count($rows)]) }})</small>
      </h3>
    </div> <!-- /.box-header -->
    ...
    <div class="box-footer">
      ...
      <div class="box-tools pull-right">
        {!! Form::open(['route' => 'admin.catalog.categorySubGroup.translate.bulk.import', 'id' => 'form', 'class' => 'inline-form', 'data-toggle' => 'validator']) !!}
        @foreach ($rows as $row)
