<div class="modal-dialog modal-md">
  <div class="modal-content">
    {!! Form::open(['route' => 'admin.catalog.category.translate.bulk.upload', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
    ...
    <div class="modal-body">
      <ul>
        ...
        <li>{!! trans('help.download_template', ['url' => route('admin.catalog.category.translate.download.template')]) !!}</li>
      ...
      <div class="row">
        ...
        <div class="col-md-3 nopadding-left">
          <div class="fileUpload btn btn-primary btn-block btn-flat">
            ...
            <input type="file" name="categoryTranslations" id="uploadBtn" class="upload" />
          </div>
        </div>
      </div>
    </div>
