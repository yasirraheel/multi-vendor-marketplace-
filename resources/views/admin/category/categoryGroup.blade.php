            ...
            <tr>
              ...
              <td>
                @if ($categoryGrp->backgroundImage?->path && Storage::exists($categoryGrp->backgroundImage->path))
                  <img src="{{ get_storage_file_url($categoryGrp->backgroundImage->path, 'small') }}" class="" alt="{{ trans('app.background_image') }}">
                @endif
              </td>
              <td>
                @if ($categoryGrp->coverImage?->path && Storage::exists($categoryGrp->coverImage->path))
                  <img src="{{ get_storage_file_url($categoryGrp->coverImage->path, 'cover_thumb') }}" class="img-sm" alt="{{ trans('app.cover_image') }}">
                @endif
              </td>
              <td>
                <h5>
