...
<div class="form-group">
  {!! Form::label('pickup_instruction', trans('app.form.pickup_instruction')) !!}
  {!! Form::textarea('pickup_instruction', null, ['class' => 'form-control summernote', 'placeholder' => trans('app.placeholder.pickup_instruction')]) !!}
  <div class="help-block with-errors"></div>
</div>
