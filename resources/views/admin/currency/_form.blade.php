...
@if (is_incevio_package_loaded('dynamic-currency'))
  @include('dynamic-currency::admin._form')
@else
  <div class="row">
    <div class="col-sm-6 nopadding-right">
      <div class="form-group">
        ...
        <div class="help-block with-errors">
          <small>https://en.wikipedia.org/wiki/ISO_4217 <a href="https://en.wikipedia.org/wiki/ISO_4217" class="indent5" target="_blank"> <i class="fa fa-external-link"></i></a></small>
        </div>
      </div>
    </div>
