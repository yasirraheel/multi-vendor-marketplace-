<div class="modal-dialog modal-md">
  <div class="modal-content">
    {!! Form::open(['route' => 'admin.vendor.shop.translate.bulk.upload', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
    ...
    <ul>
        ...
        <li>{!! trans('help.download_template', ['url' => route('admin.vendor.shop.translate.download.template')]) !!}</li>
    ...
    <div class="row">
        ...
        <div class="fileUpload btn btn-primary btn-block btn-flat">
            ...
            <input type="file" name="shopTranslations" id="uploadBtn" class="upload" />
        </div>
        </div>
    </div>
    </div>
